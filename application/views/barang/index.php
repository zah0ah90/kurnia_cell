...
<div class="card shadow mb-4">
    <div class="card-body">
        <a href="<?= base_url('barang/tambah') ?>" class="btn btn-primary float-right mb-5">Tambah</a>
                ...
                <tbody>
                    ...
                    foreach ($tabel as $data) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('barang/edit/' . $data->id) ?>"><span class="btn btn-primary">Edit</span></a>
                                <a href="<?= base_url('barang/tambah_stok/' . $data->id) ?>" class="btn btn-success">+ /
                                    -</a>
                                <a href="<?= base_url('barang/hapus/' . $data->id) ?>" class="btn btn-danger tombol-hapus">Hapus</a>
