        ...
        <div class="row" style="height: 500px;">
            ...
            <div class="col-md-6">
                ...
                <div class="text-right ">
                    <h4><b>Total Harga <div class="total-harga"></div><input type="number" hidden="hidden" class="harga"></b>
                    </h4>
                </div>
                <a href="#" class="btn btn-primary text-white float-right mx-1 " id="btnBayar"><i class="fas fa-sync-alt"></i> Bayar</a>
                <a href="#" class="btn btn-secondary text-white float-right mx-1 " id="btnClear"><i class="fas fa-sync-alt"></i> Clear</a>
            </div>
        </div>
    </div>
</div>
